...
class __TwigTemplate_ae619770cb52e2e8587ebc0456272ef701ea6673bfe4f0946c7f7ae6a95906cd extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["block" => 1, "set" => 2];
        $filters = ["escape" => 3, "t" => 3, "default" => 19];
        $functions = ["url" => 3];
...
";
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 3
        echo "    <a href=\"";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getUrl("webprofiler.dashboard", ["profile" => ($context["token"] ?? null)], ["fragment" => "routing"]), "html", null, true);
        echo "\" title=\"";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Routing"));
        echo "\">
        ...
        // line 6
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["collector"] ?? null), "getRoutesCount", [])), "html", null, true);
        echo "</span>
    </a>
    ...
    ";
        ...
        <b>";
        // line 13
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Routes"));
        echo "</b>
        <span>";
        // line 14
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["collector"] ?? null), "getRoutesCount", [])), "html", null, true);
...
";
    ...
    {
        return array (  160 => 32,  156 => 31,  148 => 26,  145 => 25,  139 => 24,  129 => 20,  125 => 19,  121 => 17,  115 => 14,  111 => 13,  108 => 12,  106 => 11,  103 => 10,  96 => 6,  92 => 5,  88 => 4,  81 => 3,  78 => 2,  72 => 1,  65 => 24,  62 => 23,  60 => 1,);
    }
    ...
    {
        return new Source("", "@webprofiler/Collector/routing.html.twig", "/var/www/html/modules/devel/webprofiler/templates/Collector/routing.html.twig");
    }
}
